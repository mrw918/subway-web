...
window.NODE_HOVER_DATA_EMBEDDED = {
    ...
    courses: [
      {
        name: "AUTOSAR CP培训",
        type: "直播课",
        url: "https://forms.cloud.microsoft/e/RQ0wFC26eF?origin=lprLink"
      },
      {
        name: "ECU软件概论",
        type: "自学课",
    ...
    courses: [
      {
        name: "DaVinci_自动错误修复",
        type: "视频课",
        url: "https://www.bilibili.com/video/BV1jSEe6kEdS/"
      },
      {
        name: "PDU传递路径可视化",
        type: "视频课",
        url: "https://www.bilibili.com/video/BV1gutgzNEoi/"
      },
      {
        name: "DaVinci基础配置(CFG6)",
        type: "直播课",
      ...
      {
        name: "DaVinci基础配置(DEVC)",
        type: "直播课",
        url: "https://forms.cloud.microsoft/e/kbWTj7PTFb?origin=lprLink"
      },
      {
    ...
    courses: [
      {
        name: "MICROSAR 多核培训",
        type: "内训课",
        detail: "本课程为付费内训课，如果您希望提高程序执行速度，您需要智能地利用多个处理器核心的强大计算能力。在本培训中，您将了解多核处理和并发的详细内容。您将学习多个使用案例、正确的配置方法以及多核处理器ECU项目中的重要边界条件。\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场50,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com\""
      },
    ],
  },
  "应用软件集成": {
    ...
    courses: [
      {
        name: "应用软件集成培训",
        type: "直播课",
        url: "https://forms.cloud.microsoft/e/mp8RCN6cxY?origin=lprLink"
      },
      {
        name: "DaVinci - 应用软件集成",
        type: "自学课",
  ...
  "DaVinci进阶配置": {
    ...
    courses: [
      {
        name: "DaVinci_获取应用层函数的触发原因",
        type: "视频课",
        url: "https://www.bilibili.com/video/BV1XHArzFE8i/"
      },
      {
        name: "DaVinci进阶培训",
        type: "直播课",
        url: "https://forms.cloud.microsoft/e/H0ySMPH1sw?origin=lprLink"
      },
      {
  ...
  "AUTOSAR通信": {
    ...
    courses: [
      ...
      {
        name: "AUTOSAR应用报文通信机制",
        type: "自学课",
        detail: "本课程为付费自学课，在整车电子系统中，不同ECU之间需要不断交换数据。例如，一个最典型的场景是：轮速ECU计算出当前车速，并将这一数据发送给仪表ECU用于显示。这个过程看似简单，但在实际系统中，却涉及复杂的软件分层与通信机制。理解这一过程，是认识AUTOSAR通信体系的重要切入点。\n本课程将以该典型场景为例，通过逐层分析车速信号在系统中的传递路径，重点讲解AUTOSAR中“应用报文通信链路”的基本原理，帮助学员建立对这一类通信机制的清晰认知。\n单人价格（一价包含Vector学习中心所有自学课程）：\n4,000元+VAT 6%/月\n40,000元+VAT 6%/年\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector学习中心进行咨询：training@cn.vector.com\""
      },
      {
        name: "AUTOSAR CP 培训",
        type: "内训课",
  ...
  "MSRC.COM": {
    ...
    courses: [
      {
        name: "DaVinci_通信组件自动配置",
        type: "视频课",
        url: "https://www.bilibili.com/video/BV1vB7h6bECh/"
      },
      {
        name: "AUTOSAR CP 培训",
        type: "公开课",
    ...
    courses: [
      {
        name: "MICROSAR 以太网培训",
        type: "内训课",
        detail: "本课程为付费内训课，在本培训中，您将获得有关以太网物理层、TCP/IP以及在汽车应用中常用协议的基础知识。您将学习以太网和TCP/IP栈与AUTOSAR软件架构的连接，并详细了解最重要的汽车使用案例。在额外的实践部分，您将通过多个练习应用之前学到的内容，在仿真环境（vVIRTUALtarget Basic）中配置MICROSAR以太网软件，以应对这些汽车使用案例。\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场50,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com\""
      },
    ],
  },
  "MSRC.ETH": {
    ...
    courses: [
      {
        name: "MICROSAR 存储培训",
        type: "内训课",
        detail: "本课程为付费内训课，非易失性内存管理必须支持基本的存储技术，如EEPROM或Flash。在本培训中，您将学习如何优化MICROSAR内存解决方案的配置以及正常运行中的行为。此外，我们还将介绍错误恢复策略以及如何定位配置中的问题。\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场30,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com\""
      },
    ],
  },
  "MSRC.Fee": {
    ...
    courses: [
      {
        ...
        type: "公开课",
        detail: "本课程为付费内训课，现代汽车与其环境的连接日益增强，这带来了对车载应用的新要求，以满足机密性、完整性和真实性的需求。在本课程的第一个模块中，您将学习汽车网络安全的基础知识。在此基础上，您将通过理论和练习探索相应的Vector解决方案。\n课程内容：\n1. 车辆信息安全的基础理论知识\n- 车辆信息安全的动因\n- 信息安全的目标\n- 设计原则和一般方法\n- 密码学算法理论知识\n- 实施方案 - 使用案例\n2. MICROSAR加密模块的基本概念\n- 算法，密钥，任务\n- 加密模块配置\n3. 演示示例：基于密码的消息认证码（CMAC）\n- 演示CMAC生成与验证的详细任务配置\n- 演示加密模块的配置（Csm模块, CryIf模块, Crypto驱动模块）\n4. 使用案例\n- SecOC的详细介绍，包含新鲜度值的管理\n- CANoe中的Security Manager配置\n- MICROSAR KeyM模块，包括证书管理\n- 安全诊断简介\n- TLS简介\n5. 实操练习 (DaVinci Configurator Classic)\n- 加密模块配置\n- 加密密钥配置\n- 加密作业配置（加解密、MAC生成与验证）\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场50,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com"
      },
      {
        name: "MICROSAR 信息安全培训",
        type: "内训课",
  ...
  "MSRC.veHSM": {
    ...
    courses: [
      {
        name: "MICROSAR veHSM培训",
        type: "内训课",
        detail: "本课程为付费内训课，现代汽车架构正在向外部世界开放，这使得机密性、真实性和完整性成为车载应用的要求。为了保护机密数据和确保加密计算的安全，许多情况下会使用硬件安全模块（HSM）。在本课程中，您将学习HSM（安全核心）的基础知识以及我们相应的Vector解决方案veHsm，例如用于各种加密任务处理、安全启动和密钥管理。\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场50,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com"
      },
    ],
  },
  "功能安全": {
  ...
  "MSRC.Safety": {
    ...
    courses: [
      {
        name: "MICROSAR 功能安全培训",
        type: "内训课",
        detail: "本课程为付费内训课，本培训将介绍MICROSAR Safe —— Vector公司为具有功能安全相关功能的ECU提供的解决方案。MICROSAR Safe使得在同一ECU（混合ASIL系统）中，安全相关的软件部分（不同ASIL级别）与非安全相关的软件部分（QM级别）能够互不干扰。您将学习如何为混合ASIL ECU中的软件实现清晰的分区策略。培训还将概述相关概念，并介绍不同的使用案例。\n在内训课中，Vector中国将与您商定培训日期，也可以基于您的培训需求进行单独的沟通。\n本课程价格为每场30,000元+6%税。\n如您有意向购买该类课程，请您联系您的对接销售，或发送邮件至Vector中国培训团队进行咨询：training@cn.vector.com"
      },
    ],
  },
};
